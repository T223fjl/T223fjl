...
<head>
    ...
    <link rel="stylesheet" rev="stylesheet" href='${pageContext.request.contextPath }/statics/css/new2015.min.css'
        ...
        <link rel="stylesheet" type="text/css" href='${pageContext.request.contextPath }/statics/css/hotel-com.css'
              media="all"/>
	<link rel="stylesheet" type="text/css" href='${pageContext.request.contextPath }/statics/css/details-2015.css' />
...
<div class="cont_box response_wrap3">
	...
	<div class="mt10 mb10">
		<div class="link555 t12">
		    <a title="首页" href="http://www.elong.com">
首页		    </a>
            ...
            <div class="hdetail_main hrela_name">
                ...
                <p class="clearfix">
		        	<span class="mr5 left">
						...
						<span class="l2 left mt5" title="街景"
                              id="sosoMap" data-svid="10011031131214121358100"
                              data-heading="0" data-pitch="0" data-zoom="0" data-mapType="2">
							<i class="icon_land_street"></i>街景
						</span>
                </p>
            </div>
            <div class="hdetail_sider hrela_say" id="favorBtnContainer">
                <div class="sd_con clearfix">
						<span class="add_collect" method="collectable" data-hotelid="50101525">
	              			<b class="icon_coll"></b>
        		...
        		<div class="hdetail_main left">
                    <div class="hrela_pic">
                    		<div class="hrela_pic_w">
                                <div class="wac">
                                    <img data-disable="false" src="${pageContext.request.contextPath }/statics/picture/nw_0004tb3a.jpg"  onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/web/pic/no-pic-b.jpg'"  height="325"/>
                        ...
                        <!--信息-->
                        <div class="hrela_picinfo">
                            <ul id="hotelDetailTabHandle" class="hrela_pinfo_list">

                                        <li class="cur on" data-handle="image_all">
                                            所有(66)
                                        </li>

                                                <li>|</li>
                                        <li class="cur " data-handle="image_exterior">
                                            外景(3)
                                        </li>
                    ...
                    <div class="hrela_spic mt5">
                        <span class="hrela_spic_prev" id="small_img_prev"><i class="icon_prev_b9"></i></span>
                        <span class="hrela_spic_next" id="small_img_next"><i class="icon_next_b9"></i></span>

                                    <ul data-handle="container" data="image_all" class="hrela_spic_list"
                                        style="width: 5940px; margin-left: 0px;">
                                            <li class="on">
        ...
        <div class="hdetail_box">
            <div class="hdetail_main left">
                ...
                <div id="tabMenu" class="hdetail_subnav bbddd">
                    ...
                    <div class="hdetail_subnav_time mt15" id="divRecentOrder" style="display:none;"><i class="icon_time24 mr5"></i>24小时内有人预订！</div>
                </div>
                <div id="searchTabHandler" class="subnav_fixed none" style="display: none;">
			                ...
			                <li method="review">点评</li>
                                ...
                                <div class="date_change right">
                                    <div class="search_item search_date">
                                        <label class="left br"><span>入住</span><input handle="inDateFloat" type="input"  value="2019-05-11" selectedValue="2019-05-11" class="input_f16 input_date"><span class="weekDesc">今天</span><span class="icon_date_s"></span></label>

                                        <label class="left"><span>离店</span><input handle="outDateFloat" type="input"  value="2019-05-12" selectedValue="2019-05-12" class="input_f16 input_date"><span class="weekDesc">明天</span><span class="icon_date_e"></span></label>
                ...
                <div class="date_change mt15 mb15">
                    <div class="search_item search_date">
                        <label class="left br"><span>入住</span><input type="input" handle="inDate" value="2019-05-11" selectedValue="2019-05-11" class="input_f16 input_date"><span class="weekDesc">今天</span><span class="icon_date_s"></span></label>

                        <label class="left"><span>离店</span><input type="input" handle="outDate" value="2019-05-12" selectedValue="2019-05-12" class="input_f16 input_date"><span class="weekDesc">明天</span><span class="icon_date_e"></span></label>
                ...
                <div class="filterContent clearfix none ">
                    ...
                    <div class="filterItem multiple ortherFilterItem none" method="other">
                        <ul>
                        </ul>
                    </div>
...
<div id="hotelContent" class="hdetail_view">
    <h2 class="hdetail_tit2">酒店信息</h2>
            <ul class="dview_icon_list">
                        <li><i class="icon_view_01"></i>
                                <p>免费WIFI</p></li>
                        <li><i class="icon_view_02"></i>
                                <p>收费停车</p></li>
                        <li><i class="icon_view_04"></i>
                                <p>餐厅</p></li>
                        <li><i class="icon_view_05"></i>
                                <p>行李寄存</p></li>
                        <li><i class="icon_view_07"></i>
                                <p>游泳池</p></li>
                        <li><i class="icon_view_08"></i>
                                <p>健身房</p></li>
                        <li><i class="icon_view_03 no"></i>
                            <p>接机服务</p></li>
                        <li><i class="icon_view_06 no"></i>
                            <p>会议服务</p></li>
            </ul>
    <div class="dview_info">
        	<dl class="dview_info_item">
                ...
                <dl class="dview_info_item">
                    <dt><i class="icon_view_s2"></i>入离时间</dt>
                    <dd>
			    ...
			    <dl class="dview_info_item">
                    <dt>
                        <i class="icon_view_warn"></i>预订须知</dt>
                    <dd class="on">
                        <p>目前北京全城禁烟，酒店均为无烟房。</p>
                    </dd>
                </dl>
        ...
        <dl class="dview_info_item" id="netAndwifi" style="display:none">
	          ...
	          <dl class="dview_info_item">
                  <dt><i class="icon_view_s5"></i>开业时间</dt>
                  <dd>酒店开业时间
                        2009年
新近装修时间                            2010 年
                  </dd>
          ...
          <dl class="dview_info_item">
              <dt><i class="icon_view_s6"></i>酒店设施</dt>
              <dd>
            	<i class="icon_hl_more1" method="showMore"></i>
                  <p>
                      免费Wifi、收费停车、游泳池、健身房、商务中心、中餐厅、西餐厅、接机服务（收费）、邮政服务、婚宴服务、叫醒服务、洗衣服务、送餐服务、旅游服务、租车服务、专职行李员、行李寄存、专职门童、礼宾服务、24小时大堂经理、旅游票务专柜、信用卡结算服务、一次性账单结算服务、免费报纸(部分)、有电梯、前台保险柜、自助取款机、旅游交通图、茶室、安全消防系统、大堂吧、公共区域闭路电视监控系统、残障人客房、酒吧、大堂报纸、无烟楼层、无障碍通道、行政酒廊、24小时热水、宴会厅、220V电压插座、多功能厅、多媒体演示系统、行政楼层、多种规格电源插座、110V电压插座、遮光窗帘、手动窗帘、房内保险箱、书桌、床具：鸭绒被、电子秤、针线包、空调、房间内高速上网、客房WIFI覆盖免费、国内长途电话、国际长途电话、有线频道、液晶电视机、免费瓶装水、电热水壶、免费洗漱用品（6样以上）、独立淋浴间、吹风机、拖鞋、浴衣、浴室化妆放大镜、洗浴间电话、沙发(部分)、熨衣设备(部分)、咖啡壶/茶壶(部分)、迷你吧(部分)、小冰箱(部分)、浴缸(部分)、所有公共及私人场所严禁吸烟、智能马桶(部分)、卫星频道、桑拿浴室、美容美发室、SPA、足浴/足疗、按摩保健
                  </p>
              </dd>
          </dl>

          <dl class="dview_info_item">
              <dt><i class="icon_view_s7"></i>酒店服务</dt>
              <dd>
                  <p>
                      棋牌麻将、桑拿按摩、SPA、游泳池、健身房
                  </p>
              </dd>
          </dl>
          <dl class="dview_info_item">
              <dt><i class="icon_view_s8"></i>酒店简介</dt>
              <dd>
            		<i class="icon_hl_more1" method="showMore"></i>
                  <p>北京唐拉雅秀酒店地处中央政务和金融商务区，紧邻金融街，可便捷前往天安门广场、西单商业中心。酒店位置优越，可将首都长安街壮观景致尽收眼底。<br>酒店是海航酒店集团旗下品牌，拥有三百余间精致客房及套房，设计风格融合了东方的典雅与西方的别致，大气且低调奢华。酒店独有的记忆型床垫，让每一位宾客酣甜入梦。<br>酒店设有总面积逾 1000平米的先进会议中心，包括一个大宴会厅和10间 多功能厅，均配备了先进的多媒体播放设备及系统，可满足不同宾客对会议及宴会需求。 <br>酒店汇聚中西美食的餐厅和酒吧；精雕细琢的中餐粤菜及专业奉茶师的服务让您享受中式餐饮之珍品；开放式厨房的西餐厅，新鲜烹制中西式美食，提供早、中、晚自助餐，是宾客挥洒热情、品味驻足的好去处。<br>温馨典雅的SPA和设备完善的健身中心，以及设于顶层、可鸟瞰西长安街全景的豪华商务会所，则为中外宾客提供华贵舒适的专属高端商旅体验。</p>
              </dd>
          </dl>
		
		  <dl class="dview_info_item">
              <dt><i class="icon_view_s10"></i>证照信息</dt>
                    <dd>
                            &nbsp;&nbsp;<a method="showSupplierLicense">查看供应商信息</a>
                </dd>
          </dl>

          	<dl class="dview_info_item dview_info_card">
                <dt><i class="icon_view_s9"></i>可接受的信用卡</dt>
                <dd>
		          			<i class="icon_card3"></i>
		          			<i class="icon_card2"></i>
		          			<i class="icon_card1"></i>
		          			<i class="icon_card5"></i>
		          			<i class="icon_card4"></i>
                    &nbsp;
                </dd>
            </dl>
    </div>
...
<div class="m_htcmt" id="review" method="commentContainer">
<h3 class="cmt_tit">点评</h3>
<div class="cmt_hd">
<div class="cmt_tp">
<div class="cmt_nmb">
<span class="u_nmb">4.5</span>
<span class="u_nmbtxt">棒极了</span>
</div>
<div class="cmt_sylst">
<ul class="lst_nmb">
<li><span class="s_tit">设施</span><span class="s_nbm">4.5</span></li>
<li><span class="s_tit">服务</span><span class="s_nbm">4.5</span></li>
<li><span class="s_tit">卫生</span><span class="s_nbm">4.6</span></li>
<li><span class="s_tit">位置</span><span class="s_nbm">4.7</span></li>
<li><span class="s_tit">性价比</span><span class="s_nbm">4.4</span></li>
</ul>
<div class="lst_txt">
<a href="javascript:void(0);" class="on" method="tagItem" data-mainid="0">
<span class="s_c333">不限</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10012" >
<span class="s_c333">出行方便</span>
<span class="s_c888">830</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10079" >
<span class="s_c333">交通便利</span>
<span class="s_c888">463</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10080" >
<span class="s_c333">地理位置好</span>
<span class="s_c888">579</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10031" >
<span class="s_c333">环境好</span>
<span class="s_c888">840</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10028" >
<span class="s_c333">性价比高</span>
<span class="s_c888">559</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10039" >
<span class="s_c333">服务态度好</span>
<span class="s_c888">426</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10038" >
<span class="s_c333">服务周到</span>
<span class="s_c888">340</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10060" >
<span class="s_c333">设施设备好</span>
<span class="s_c888">331</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10153" >
<span class="s_c333">早餐好</span>
<span class="s_c888">242</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10061" >
<span class="s_c333">设施齐全</span>
<span class="s_c888">215</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10016" style="display:none" data-hide="1">
<span class="s_c333">前台热情</span>
<span class="s_c888">174</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10100" style="display:none" data-hide="1">
<span class="s_c333">离地铁站近</span>
<span class="s_c888">138</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10010" style="display:none" data-hide="1">
<span class="s_c333">前台服务不错</span>
<span class="s_c888">124</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10088" style="display:none" data-hide="1">
<span class="s_c333">购物方便</span>
<span class="s_c888">77</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10146" style="display:none" data-hide="1">
<span class="s_c333">泳池好</span>
<span class="s_c888">68</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10152" style="display:none" data-hide="1">
<span class="s_c333">餐饮不错</span>
<span class="s_c888">59</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10007" style="display:none" data-hide="1">
<span class="s_c333">强烈推荐</span>
<span class="s_c888">50</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10030" style="display:none" data-hide="1">
<span class="s_c333">环境优雅</span>
<span class="s_c888">42</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10018" style="display:none" data-hide="1">
<span class="s_c333">床品舒适</span>
<span class="s_c888">37</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10068" style="display:none" data-hide="1">
<span class="s_c333">浴缸大</span>
<span class="s_c888">25</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10174" style="display:none" data-hide="1">
<span class="s_c333">有味道</span>
<span class="s_c888">50</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10199" style="display:none" data-hide="1">
<span class="s_c333">卫生差</span>
<span class="s_c888">42</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10169" style="display:none" data-hide="1">
<span class="s_c333">地毯脏</span>
<span class="s_c888">31</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10173" style="display:none" data-hide="1">
<span class="s_c333">隔音差</span>
<span class="s_c888">17</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10184" style="display:none" data-hide="1">
<span class="s_c333">性价比低</span>
<span class="s_c888">14</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10178" style="display:none" data-hide="1">
<span class="s_c333">噪音大</span>
<span class="s_c888">12</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10192" style="display:none" data-hide="1">
<span class="s_c333">环境差</span>
<span class="s_c888">12</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10207" style="display:none" data-hide="1">
<span class="s_c333">周边环境差</span>
<span class="s_c888">9</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10206" style="display:none" data-hide="1">
<span class="s_c333">公交不方便</span>
<span class="s_c888">8</span>
</a>
<a href="javascript:void(0);" method="tagItem" data-mainid="-1" data-subid="10172" style="display:none" data-hide="1">
<span class="s_c333">卫生间小</span>
<span class="s_c888">6</span>
</a>
<a href="javascript:void(0);" class="more_arr" method="toggleTagStatus" data-showstatus="0"><span class="s_c333">展开</span></a>
</div>
</div>
</div>
<div class="cmt_nav">
<ul class="nav_lst">
<li class="on" method="commentType" data-typeid="0" data-count="10031">
全部(9999+)
</li>
<li class="" method="commentType" data-typeid="1" data-count="9625">
推荐(9625)
</li>
<li class="" method="commentType" data-typeid="2" data-count="396">
不推荐(396)
</li>
<li class="" method="commentType" data-typeid="3" data-count="356">
带图点评(356)
</li>
</ul>
<div class="nav_form">
<select class="nav_sct" method="commentSort">
<option value="1">按热门排序</option>
<option value="0">按时间排序</option>
</select>
<select class="nav_sct" method="commentRoomType" style="display:none">
<option value="">选择房型</option>
</select>
</div>
</div>
</div>
<div class="mt20 mb20 tc t14" id="commentLoading">
...
<div id="rightSider" class="hdetail_sider right hdetail_sider_none">
       	...
       	<div id="surroundingHotelContainer"></div>
	      	<div class="dsider_perim_more">
	       		<a target="_blank" href="/search/list_cn_0101.html?startLat=39.91372316&startLng=116.3497983&starLevels=5&keywordsType=99&keywords=%E5%8C%97%E4%BA%AC%E5%94%90%E6%8B%89%E9%9B%85%E7%A7%80%E9%85%92%E5%BA%97"><span>查看周边同价位酒店</span><i class="icon_sort_arrr4"></i><i class="icon_perim_b"></i></a>
	      	</div>
	    <div class="dsider_service_us">
	        ...
	        <div class="service_infs">
	          <ul class="clearfix">
	            <li>
	              <i class="why_icon1"></i>
	              <span class="tit">更多酒店</span>
	              <span class="txt">全球110万家酒店</span>
	            </li>
	            <li>
	              <i class="why_icon2"></i>
	              <span class="tit">超值优惠</span>
	              <span class="txt">订酒店返现高达20%</span>
	            </li>
	            <li>
	              <i class="why_icon4"></i>
	              <span class="tit">卓越服务</span>
	              <span class="txt">7x24小时服务</span>
	            </li>
	          </ul>
	        </div>
	    </div>
        ...
        <div class="clx"></div>
			...
			<div class="listSEO">
				<h2>北京酒店信息
					<i class="icon_SEO_e" id="detailSeoExpand"></i></h2>
				<div class="hotelsNearby link999" id="detailSeoZone" style="display:none;">

						<h3>北京唐拉雅秀酒店怎么样</h3>
			        		<p>房间的客房部分太小，卫生间的干湿区加上衣帽间的面积居然要大于客房的面积？分配明显不合理。另外马桶的地漏有明显的异味。酒店的服务人员特别是前台，服务素质还是比较好的，早餐种类齐全，值得一试。周边交通出行也较为方便。环境十分不错，服务态度也好，离天安门很近，值得大家选住。位置很好，设施比较新，但问题是服务业余，管理有问题。</p>
						<h3>北京唐拉雅秀酒店附近酒店</h3>
			        		<p>速8酒店(北京宣武门店)|北京龙福宫宾馆(西直门店)|北京龙福宫宾馆(复兴路翠微店)|龙福宫宾馆(北京丽泽桥店)|如家快捷酒店(北京紫竹桥店)|北京欣燕都连锁酒店(菜市口店)|7天连锁酒店(北京天安门店)(原北京天安门店)|锦江之星(北京广安门店)|7天连锁酒店(北京大观园店)|7天连锁酒店(北京西直门店)(原北京西直门店)</p>
						<h3>北京唐拉雅秀酒店附近酒店推荐</h3>
			        	<p>
			        			<a href="/beijing/">北京酒店</a>
			                        |
			        			<a href="/beijing/star2.html">北京快捷酒店</a>
			                        |
			        			<a href="/beijing/district100025527/">北京西城区酒店</a>
			                        |
			        			<a href="/beijing/district100025527/star2.html">北京西城区快捷酒店</a>
			                        |
			        			<a href="/beijing/chain28.html">北京海航酒店</a>
			                        |
			        			<a href="/hotel-chain/28.html">海航酒店</a>
			                        |
			        			<a href="/beijing/district100025527/chain28.html">北京西城区海航酒店</a>
			                        |
			        			<a href="/00101395/">北京万博苑旅馆</a>
			                        |
			        			<a href="/00101437/">北京后海三宝四合院青年客栈</a>
			                        |
			        			<a href="/00101469/">北京博安商务连锁酒店</a>
			                        |
			        			<a href="/00101549/">北京卡普连锁酒店</a>
			                        |
			        			<a href="/00101589/">北京金诺威快捷酒店</a>
			                        |
			        			<a href="/00101616/">北京锦绣庄四合院宾馆电话</a>
			                        |
			        			<a href="/00101636/">北京鸿星宾馆</a>
			                        |
			        			<a href="/00101641/">北京牡丹旅馆</a>
			                        |
			        			<a href="/00101657/">北京广外京滨招待所</a>
			                        |
			        			<a href="/00101667/">北京沙钢宾馆</a>
			        	</p>
			 </div>
			</div>
...
<!--新图片浮层  Start-->
<div data-handle="photoBox" class="grieshoch_80 fixed" style="display: none;">
    <iframe style="width:100%;height:100%;position:relative;background:#fff;opacity:0;filter:progid:DXImageTransform.Microsoft.Alpha(Opacity=0); "
            frameborder="0"></iframe>
</div>
<div data-handle="photoBox" class="float_rpic_wrap fixed  none" style="top: 50%; margin-top: -310px; display: none;">
    <div class="float_wrap1000">
        <b class="icon_close_rpic" method="close"></b>
        <i class="icon_prev_c38" method="prevImg"></i>
        <i class="icon_next_c38" method="nextImg"></i>
        <div class="float_rpic">
            <div id="imgContainer" class="dffc">
                <img data-handle="img" class="show_imgzz" data-src="${pageContext.request.contextPath }/statics/picture/nw_0004tb3a.jpg" src="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_0004Tb3A.jpg"
                     onerror="this.src='http://m.elongstatic.com/static/webapp/pc_static/pc_hotel/other/hotels/pic/no_pics_CN.gif'"/>
                <img class="alpha_imgzz" src="${pageContext.request.contextPath }/statics/picture/pixel.gif"/>
            </div>
            <div id="fullview" style="position:absolute;display:none;width:100%;height:400px;"></div>
            <div id="sosofullview" style="position:absolute;display:none;width:100%;height:400px;"></div>
    ...
    <div class="float_spic mt20">
        <div class="response_wrap3">
            ...
            <div data-handle="thumbnailUL" class="hrela_spic mt5">
                <span method="prevPage" class="hrela_spic_prev" id="big_img_prev"><i class="icon_prev_b9"></i></span>
                <span method="nextPage" class="hrela_spic_next" id="big_img_next"><i class="icon_next_b9"></i></span>

                                    <ul data-handle="image_all" style="position:absolute;left:0px;"
                                        class="hrela_spic_list" id="layerimagegroup">
                                            <li method="showBigImg" isPanorama="" data-name="外观">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_0004tb3a.jpg"
                                                     ...
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_0004Tb3A.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="客房">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/0000adou.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/0000aDoU.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="外观">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3columpg.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3cOLUmpG.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="外观">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtb8e3x9c.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtB8E3x9C.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="大堂/接待台">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000bene7.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000bEne7.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="客房">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_fxqalml9ja.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                            ...
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_fxqbkjgvy4.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FXQbkJgVY4.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3fcfwqa0.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3fcfWqA0.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3ekyuqlk.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3eKyUQLK.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3ejv3uuo.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3ejv3UUo.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3dp4zorc.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3dP4zOrC.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3djtftwc.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3djTfTwc.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3cga5yig.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3cGA5YIg.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3c8ik1b6.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3c8ik1B6.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3bfxrvbs.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3bFxrvBS.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft3ayr5dwo.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft3aYR5dWo.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft39r6s0py.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft39R6S0py.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft39jbdsdo.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft39JBDsdO.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frty1sbwbi.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Frty1sBwBi.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtxtjujka.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtxTjUJkA.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000e7fr9.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000e7FR9.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000e7fqb.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000e7FQB.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="餐厅">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000bendq.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000bEndq.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="会议室">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtcstdlla.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtCStDLLa.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="会议室">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtcfnw62c.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtCfNW62c.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="会议室">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtazpdhlq.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtAZPDHLq.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="会议室">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtavzn9yy.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtAvzn9YY.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="会议室">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frta34fmpq.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtA34FMpq.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="会议室">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtxjt3xjm.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Frtxjt3XJm.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="会议室">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000e7fq4.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000e7FQ4.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="会议室">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000e7fof.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000e7FOF.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="休闲">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_fxq8hhqieo.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FXQ8hHQiEo.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="休闲">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtbklieus.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtBkliEus.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="休闲">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtzanb9oa.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtzaNB9oA.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="休闲">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtz1oz4e4.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Frtz1oz4e4.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="休闲">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtyq8r2vu.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtyQ8R2vu.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="休闲">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtyjvpstg.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtyjvPStG.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="休闲">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000bend6.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000bEnd6.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="休闲">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000dapvj.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000dAPVj.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="公共区域">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtd78fl7g.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtD78fL7G.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="公共区域">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtczysjwu.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtCZYSjWU.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="公共区域">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000h9jmt.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000h9JMt.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="公共区域">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000benfy.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000bEnfY.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="公共区域">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000beyqt.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000bEyQT.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="公共区域">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000benfn.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000bEnfn.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="公共区域">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000dapv4.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000dAPV4.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="公共区域">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000dapus.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000dAPUS.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="公共区域">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_0004tdcj.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_0004TdCj.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="周边图片">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_ft39yxxfcg.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_Ft39YXXFCg.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="周边图片">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtbrcus7u.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtBRCUs7u.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="其他">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_frtycdun6m.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_FrtycDun6M.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="其他">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000fykhd.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000fykhd.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="其他">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000dapwl.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000dAPWl.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="其他">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000dapwc.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                                     bigImgUrl="//pavo.elong${pageContext.request.contextPath }/statics.com/i/Hotel870_470/nw_000dAPWc.jpg" width="80" height="80"/>
                                            </li>
                                            <li method="showBigImg" isPanorama="" data-name="客房">
                                    ...
                                    <ul data-handle="image_exterior" style="display:none;position:absolute;left:0px;"
                                        class="hrela_spic_list" id="layerimagegroup">
                                            <li method="showBigImg" isPanorama="" data-name="外观">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_0004tb3a.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                    ...
                                    <ul data-handle="image_interior" style="display:none;position:absolute;left:0px;"
                                        class="hrela_spic_list" id="layerimagegroup">
                                            <li method="showBigImg" isPanorama="" data-name="大堂/接待台">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/nw_000bene7.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
                                    ...
                                    <ul data-handle="image_room" style="display:none;position:absolute;left:0px;"
                                        class="hrela_spic_list" id="layerimagegroup">
                                            <li method="showBigImg" isPanorama="" data-name="客房">
                                                <img data-src="${pageContext.request.contextPath }/statics/picture/0000adou.jpg"
                                                     onerror="this.src='http://m.elong${pageContext.request.contextPath }/statics.com/${pageContext.request.contextPath }/statics/webapp/pc_${pageContext.request.contextPath }/statics/pc_hotel/other/hotels/pic/no_pics_CN.gif'"
