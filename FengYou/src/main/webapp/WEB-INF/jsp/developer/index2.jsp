...
<ul class="filter_cb_list filter_cb_list1">
	...
	<li data-type="price"  class="condition" data-id="${price.dictCode }" data-low="${fn:split(price.info, '-')[0]}" data-high="${fn:split(price.info, '-')[1]}"
	data-name="${price.info}" <c:if test="${CurPrice.dictCode==price.dictCode }"> id="curPrice" </c:if> >
...
<ul class="filter_cb_list">
		...
		<li data-type="star" class="condition" data-id="${star.dictCode }" data-name="${star.info }"
		data-selected="0" <c:if test="${CurStar.dictCode==star.dictCode }"> id="curStar" </c:if> >
...
<div class="filter_item " method="themeFilterPart" data-type="city" data-typeId="1015"
data-multi="1">
...
<ul class="filter_cb_list" method="themeList">
	<c:forEach var="type" items="${ types}" step="1" varStatus="statu">
		<li  class="condition" data-type="type" data-typeId="${type.type }" data-id="${type.id }" data-name="${type.name }"
		data-selected="0" <c:if test="${CurType.id==type.id }"> id="curType" </c:if> >
		<i class="icon_radio1"></i>
...
<ul class="filter_cb_list" method="facilityList">
	<c:forEach var="city" items="${ citys}" step="1" varStatus="statu">
		<li method="facility" data-type="city" class="condition" data-typeId="${city.type }" data-id="${city.id }" data-name="${city.name }"
		data-selected="0"  <c:if test="${CurCity.id==city.id}"> id="curCity" </c:if> >
		<i class="icon_radio1"></i>
...
<c:forEach var="hotel" items="${ hotels.list}" step="1" varStatus="statu">
...
<img class="bigImg" data-hotelid="${ hotel.hotelId}" data-producttype="0" data-needdatacache="true" data-mark="img_${ hotel.hotelId}" onerror="this.src='${pageContext.request.contextPath }/statics/picture/no-f-pic.jpg'" src="http://m.elongstatic.com/static/webapp/pc_static/common/pic/loading180_130.gif" 
...
<div id="m_adsContainer" style="display: none"></div>
          <!-- ===================== footer 20190403 start ===================== --> <div class="clear"></div> <div class="footer" r="3"> <div class="footer_info"> <dl> <dt>加盟合作</dt> <dd> <a href="http://hotel.elong.com/union/join.html#?" title="酒店加盟" rel="nofollow">酒店加盟</a> </dd> <dd> <a href="http://open.elong.com/" title="机票酒店分销联盟" rel="nofollow">开放平台</a> </dd> <dd> <a href="http://promotion.elong.com/hotel/cn/elongagent/elongagent.html " title="旅游产品代理合作" rel="nofollow">代理合作</a> </dd> <dd> <a href="http://promotion.elong.com/web/adservice/adservice.html" title="在线广告服务" rel="nofollow">广告服务</a> </dd> <dd> <a href="http://ebooking.elong.com/ebkauth/login" title="风游商家中心" rel="nofollow">商家中心</a> </dd> </dl> <dl> <dt>关于风游</dt> <dd> <a href="http://hotel.elong.com/directory/" title="酒店大全">酒店大全</a> </dd><dd> <a href="http://ihotel.elong.com/sitemap/" title="国际酒店">国际酒店</a> </dd><dd> <a href="http://promotion.elong.com/web/insurance/index.html" title="旅行保险">旅行保险</a> </dd><dd> <a href="http://promotion.elong.com/index/cn/campus/index.html" title="校园招聘" rel="nofollow">校园招聘</a> </dd> <dd> <a href="https://d.elong.com/a/contact" title="联系风游旅行网" rel="nofollow">联系我们</a> </dd> </dl> <dl> <dt>风游APP下载</dt> <dd class="pt10"> <i class="cm_icon footer_info_app"></i> </dd> </dl> <dl> <dt>风游官方微信</dt> <dd class="pt10"> <i class="cm_icon footer_info_wx"></i> </dd> </dl> <dl> <dt>风游官方小程序</dt> <dd class="pt10"><i class="cm_icon footer_info_xcx"></i></dd> </dl> </div> <div class="clx"></div> <div class="footer_copy"> &#169; 2000 - 2019 北京风游信息技术有限公司, eLong, Inc or its affiliates. All Rights Reserved. <i class="cm_icon"></i> <a rel="nofollow" target="_blank" href="http://m.elongstatic.com/pcheaderfooter/2018/06/files/headerfoot/img/ICP_20180015.pdf">ICP证:合B2-20180015</a> <br>
           <a rel="nofollow" target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010502026059"> 
           <i style=" background-image: url(static/images/anbei.png); background-size: contain; background-position: 0; height: 20px; width: 20px;"></i> 京公网安备11010502026059号</a> <i class="cm_icon"></i> 
           <a rel="nofollow" target="_blank" href="http://m.elongstatic.com/pcheaderfooter/2018/06/files/headerfoot/img/company_105145723.pdf">经营执照</a> 
           <i class="cm_icon"></i> <a rel="nofollow" target="_blank" href="http://m.elongstatic.com/hotel/eltk/eltk.html">《风游旅行网服务条款》</a><i class="cm_icon"></i>违法和不良信息举报电话：95711-9<i class="cm_icon"></i>
           <a rel="nofollow" href="mailto:wfjb@ly.com">举报邮箱：wfjb@ly.com</a></div> <div class="footer_safe"> <a class="cm_icon qua-1" href="https://trustsealinfo.websecurity.norton.com/splash?form_file=fdf/splash.fdf&dn=*.elong.com&lang=zh_CN" rel="nofollow" target="_blank" alt="SSL加密认证" title="SSL加密认证">SSL加密认证</a>
            <a title="风游网通过PCI认证" alt="风游网通过PCI认证" target="_blank" rel="nofollow" href="http://www.atsec.cn/cn/pci-attestation/Elong-PCIAttestation-atsec-PCI-DSS-C-01128.jpg" class="cm_icon qua-6">风游网通过PCI认证</a>
            <a class="cm_icon qua-3" href="http://www.itrust.org.cn/Home/Index/satification_certificate/wm/MY2019042401.html" rel="nofollow" target="_blank" alt="信赖商业计划" title="信赖商业计划">信用评级</a>
             <a class="cm_icon qua-4" href="http://search.szfw.org/cert/l/CX20120918001652001722" rel="nofollow" target="_blank" title="诚信示范企业" alt="诚信示范企业">诚信示范企业</a> <a alt="品牌官网认证" title="品牌官网认证" target="_blank" rel="nofollow" href="http://si.trustutn.org/info?sn=912170105026585086807&amp;certType=1" class="cm_icon qua-7">品牌官网认证</a> 
             </div> </div> <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/css/styles.css"> <!-- ===================== footer end ===================== --> 
<!-- 可信网站LOGO安装开始 -->
	<div style="display: none;">
		<form id="form" action="toIndex2">
		<input type="text" id="bigPrice" name="bigPrice" value="${fn:split(CurPrice.info, '-')[1]}" >
		<input type="text" id="smallPrice" name="smallPrice"  value="${fn:split(CurPrice.info, '-')[0]}"  >
		<input type="text" id="city" name="city"  value="${CurCity.id }"  >
		<input type="text" id="star" name="star"   value="${CurStar.dictCode }" >
		<input type="text" id="type" name="type"  value="${CurType.id }"  >
		<input type="text" id="price" name="price" value="${CurPrice.dictCode }" >
		</form>
	</div>
	...
	<script type="text/javascript">
		...
		$(function() {
			for (var i = 0; i < $(".bigImg").length; i++) {
				$(".bigImg").eq(i).attr("src",$(".bigImg").eq(i).attr("data-src"))
			}
			var price=$("#price").val();
			if(price!=''&&price!=null){
				var html='<i>您已选择：</i><a title="清空条件" onclick="clearCondition()" href="javascript:void();">清空条件</a><span title="删除此条件" data-type="'+$("#curPrice").attr("data-type")+'" onclick="delCondition(this)" data-id="'+$("#curPrice").attr("data-id")+'"  data-high="'+$("#curPrice").attr("data-high")+'"   data-low="'+$("#curPrice").attr("data-low")+'"   >'  +
				$("#curPrice").attr("data-name")+'<i class="icon_close_hl"></i></span>';
				if($(".cond-list").html()==''){
					$(".cond-list").html(html)
				}
			}
			...
			var city=$("#city").val();
			if(city!=''&&city!=null){
				var html='<i>您已选择：</i><a title="清空条件" onclick="clearCondition()" href="javascript:void();">清空条件</a><span title="删除此条件" data-type="'+$("#curCity").attr("data-type")+'" onclick="delCondition(this)" data-id="'+$("#curCity").attr("data-id")+'>'
				$("#curCity").attr("data-name")+'<i class="icon_close_hl"></i></span>';
				if($(".cond-list").html()==''){
					$(".cond-list").html(html)
				}else{
					html='<span title="删除此条件" data-type="'+$("#curCity").attr("data-type")+'" onclick="delCondition(this)" data-id="'+$("#curCity").attr("data-id")+'">'  +
					$("#curCity").attr("data-name")+'<i class="icon_close_hl"></i></span>';
					...
					if($("#curCity").attr('data-type')==''){
						...
						for (var int = 0; int < $(".cond-list").find("span").length; int++) {
							if($("#curCity").attr('data-type')==$(".cond-list").find("span").eq(int).attr('data-type')){
		...
		$(".condition").click(function() {
					...
					if($(this).attr('data-type')=="star"){
						$("#star").val($(".cond-list").attr('data-id'));
					}
