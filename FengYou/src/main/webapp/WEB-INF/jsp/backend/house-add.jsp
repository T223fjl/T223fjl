...
<body>
	<div class="pd-20">
		<div class="page-container">
			<form action="Savehouse"  class="form form-horizontal"
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text"
							placeholder="请输入房间床型" id="" name="houseType" required="required">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
			     <label>
                <select name="isHavingBreakfast" required="required">
                <option value="0">
                是
                </option>
                  <option value="1">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text"  class="input-text"
							 id=""	name="contentOne"   placeholder="请输入面积">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="checkbox" name="contentTow" value="无线 " />无线
							<input type="checkbox" name="contentTow"  value="有线 " />有线
					</div>
				...
				<div class="row cl">
					...
					<input   class="input-text"
						 placeholder="请输入楼层（1-10）" name="contentThree" type="text" >
					</div>
