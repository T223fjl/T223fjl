...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加角色" data-href="add" onclick="Hui_admin_tab(this)" href="add"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a></span> <span class="r">共有数据：<strong>${count }</strong> 条</span> </div>
	<div class="mt-20">
	 ...
	 <th width="40"><input name="checks" type="checkbox"  ></th>
			...
			<c:forEach var="dictionarydate" items="${ dictionarydates}" step="1" varStatus="statu">
				<tr class="text-c">
					...
					<td class="text-l"><u style="cursor:pointer;text-align: center;" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看">${ dictionarydate.typeCode}</u></td>
					<td>${ dictionarydate.dictCode}</td>
					<td>${ dictionarydate.info}</td>
					<td>${ dictionarydate.typeName}</td>
