...
public class PayController {
	...
	public String subOrder(String houseId,String checkInDate,String checkOutDate, String email, String phone, 
			String userNames,String place,String payAmount, String houseCount,String day, Model model,HttpSession session) throws ParseException{
			...
			if(checkInDate!=null&&houseId!=null&&checkOutDate!=null&&email!=null
				...
				if(result>0){
					...
					if(r==null){
						...
						r.setRecordStopDate(format.parse(format.format(getNextDate(r.getRecordDate(), Integer.valueOf(day)))));
