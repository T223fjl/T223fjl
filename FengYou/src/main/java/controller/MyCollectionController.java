...
public class MyCollectionController {
	...
	public void collectAdd(String hotelId,HttpSession session, HttpServletResponse response) throws IOException, ParseException{
	...
	public void collectDel(String hotelById,HttpSession session, HttpServletResponse response) throws IOException, ParseException{
