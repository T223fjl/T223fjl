...
<%@include file="/jsp/common/head.jsp"%>
	...
	function aa() {
        ...
        <div class="right">
            ...
            <div class="search">
           		<form method="post" action="userQuery">
					<input name="method" value="query" class="input-text" type="hidden">
					 <span>用户名：</span>
					 <input id="queryname" name="queryname" class="input-text"	type="text" value="${queryUserName }">
					 ...
					 <input	value="查 询" type="submit" id="searchbutton">
					  <input type="button" onclick="del()"  value="删除按钮"/>
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <tr class="firstTr">
                	<th>
						<span>99999999999<input type="checkbox"  id="allDel" onclick="selectAll()" /> </span>
					</th>
                    <th width="10%">用户编码</th>
                    <th width="20%">用户名称</th>
                    <th width="10%">性别</th>
                   ...
                   <c:forEach var="user" items="${userList }" varStatus="status">
					...
					<tr>
						<td>
						<span><input type="checkbox" class="delS" userid=${user.id } /> </span>
						</td>
						<td>
