...
<div class="right">
        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/UpdateBill">
                ...
                <div>
                    <label >是否付款：</label>
                    <c:if test="${bill.isPaymen == 1 }">
						<input type="radio" name="isPaymen" value="1" checked="checked">未付款
						<input type="radio" name="isPaymen" value="2" >已付款
					</c:if>
					<c:if test="${bill.isPaymen == 2 }">
						<input type="radio" name="isPaymen" value="1">未付款
						<input type="radio" name="isPaymen" value="2" checked="checked">已付款
					</c:if>
                </div>
